...
- The plant stomata their functioning is dependent on several atmospheric states such as $T$, $q$ and $CO_2$.

## Voluntary problem 5 

There are many relationships still unexplored^[For the very curious, plenty of additional experiments can be found in @ABL_handbook]. In this **voluntary** problem, the effect of a higher air temperature on the partioning of the fluxes is investigated. Consistent with the other problems of this practical, the mixed layer model is still not used so that, making $\langle \theta \rangle$ constant throughout the duration of the simulation.
...
Additionally, complete the feedback diagrams give in @fig-feedback_theta_1 and @fig-feedback_theta_2. Based on your results, which one is dominating in this case? 
